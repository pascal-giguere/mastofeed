import { decodeMFID, encodeMFID, extractUrlFromToothContent, extractMFIDFromUrl } from '../../src/utils/mfid';
...
describe('Mastofeed identifier (MFID)', () => {
  ...
  it("extracts an URL from a tooth's content", () => {
    expect(
      extractUrlFromToothContent(
